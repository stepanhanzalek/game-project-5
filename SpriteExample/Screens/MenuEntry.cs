...
namespace WrongHole.Screens
{
    ...
    public class MenuEntry
    {
        ...
        public virtual void Draw(MenuScreen screen, bool isSelected, GameTime gameTime)
        {
            ...
            float scale = 1 + pulsate * 0.01f * _selectionFade;
            ...
            var origin = font.MeasureString(_text) / 2;

            spriteBatch.DrawString(font, _text, _position + font.MeasureString(_text) / 2, color, 0,
